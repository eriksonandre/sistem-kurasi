...
// Ambil semua data dari tabel sertifikat
$query = "SELECT s.kode_sertifikat, s.kode_usaha, s.kode_produk, s.foto_sertifikat, p.nama_produk, pu.nama_usaha, pu.nama_pemilik 
          FROM sertifikat s
