...
$query = "INSERT INTO penilaian_food (kode_produk, kode_usaha, rasa, packaging, harga, ketahanan, nilai, penilai)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = $connection->prepare($query);
$stmt->bind_param("isssssss", $kode_produk, $kode_usaha, $rasa, $packaging, $harga, $ketahanan, $nilai, $penilai);
